...
module.exports = {
    name: "pixelate",
    category: "4fun",
    aliases: ["pixeloza", "pikseloza"],
    description: "ALE PIXELOZA!!1!1!!1",
    run: async (client, message, args) => {
        const user = message.mentions.users.first() || message.guild.members.cache.get(args[0]) || message.author
        const GoodEmbed = new MessageEmbed()
            .setTitle("ALE PIXELOZA!!1!1!!1")
            .setColor('#002d96')
            .setImage(`https://api.luxbot.ml/pixelate?image=${user.displayAvatarURL({dynamic: true})}`)
